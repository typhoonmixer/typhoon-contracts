...
//     commitment.append(0.try_into().unwrap());
//     commitment.append(1.try_into().unwrap());
//     commitment.append(2.try_into().unwrap());

//     let mut pool: Array<ContractAddress> = ArrayTrait::<ContractAddress>::new();
//     pool.append(0.try_into().unwrap());
//     pool.append(1.try_into().unwrap());
//     pool.append(2.try_into().unwrap());
//     pool.append(3.try_into().unwrap());

//     dispatcher.deposit(commitment, pool, false);
// }
